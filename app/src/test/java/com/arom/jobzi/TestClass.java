...
//        float actual = ConverterUtil.convertCelsiusToFahrenheit(100); // expected value is 212
...
//        float actual = ConverterUtil.convertFahrenheitToCelsius(212); // expected value is 100
