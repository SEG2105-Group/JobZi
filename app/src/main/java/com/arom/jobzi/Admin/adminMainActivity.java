...
public class adminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().add(R.id.container, fragmentServices).commit();

        FragmentUsers fragmentUsers = new FragmentUsers();
        getSupportFragmentManager().beginTransaction().add(R.id.container, fragmentUsers).commit();
